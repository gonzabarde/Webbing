...
| **BALDOSA** (archivo urbano BA — **proyecto de práctica / stress test arquetipo #5, sin GATE 4**) | **#5 Autoridad/Contenido (PRIMER #5 del portfolio)** — fuente: `baldosa-web/_webbing/05_CDL_1a5_juicio.md` | **Experto + Guía** (Experto secundario en SAVIA/Calibre y Guía secundario en VINCA: evaluados árbol #8, categorías/voces sin confusión — combinación inédita) — fuente: `baldosa-web/_webbing/03_M2_M3_marca_tipografia.md` | **Besley (display) / Piazzolla (body)** — primera body SERIF del portfolio; descartadas Libre Franklin (fork-linaje de Public Sans/SAVIA) y Archivo (Tatuaje) — fuente: `baldosa-web/_webbing/03_M2_M3_marca_tipografia.md` | papel frío-neutro `#F2F1EC` · tinta `#1A1C1F` (15.10) · gris `#585D60` (5.90) · **carmín sello (acento único, rol: la anotación/referencia)** `#A3231F` (6.59) · carmín-luz `#EE6B5F` (5.05 solo sobre oscuro) · contrafondo archivo `#22252B` · borde-ctrl `#75786E` (3.98) — medidos por rol §2.4.5 — fuente: `baldosa-web/_webbing/04_M4_M45_M5_M55_creatividad.md` | **"La ciudad anotada"** — fuente: `baldosa-web/_webbing/04_M4_M45_M5_M55_creatividad.md` | **"La anotación"** (superíndice carmín + nota al margen: mecanismo REFERENCIA texto→evidencia — NO línea/marca-que-se-posa/reveal/giro/gauge/onda/luz). Motion: **"sereno, editorial, seco"** — fuente: `baldosa-web/_webbing/04_M4_M45_M5_M55_creatividad.md` | HOME: Portada-índice → Series → Del Archivo → Glosario → Por qué citarnos → Newsletter → Footer · ENSAYO: expediente → cuerpo anotado → mapa → fuentes → Seguí leyendo → newsletter — fuente: `baldosa-web/_webbing/05_CDL_1a5_juicio.md` | documental actual, color natural, sombras frías neutras, detalle urbano frontal; SIN sepia/antes-después; práctica → mapas SVG propios (d) + foto pendiente declarada — fuente: `baldosa-web/_webbing/04_M4_M45_M5_M55_creatividad.md` | RULE-DRIVEN SYSTEM + ASYMMETRIC BALANCED (M9.1) · EDITORIAL HERO como tapa-índice + MEDIA NARRATIVE BLOCK + PROOF BLOCK + CONVERSION CTA BLOCK (M9.2) — vs única otra fila poblada (Calibre: tablero de instrumentos + gauge radial): patrón principal y componentes distintos — fuente: `baldosa-web/_webbing/07_M9-8_firma.md` |
